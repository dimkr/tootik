...
func TestBio_Throttled(t *testing.T) {
	...
	summary := server.Handle("/login/bio?Hello%20world", server.Alice)
...
func TestBio_TooLong(t *testing.T) {
	...
	summary := server.Handle("/login/bio?", server.Alice)
...
func TestBio_MultiLine(t *testing.T) {
	...
	summary := server.Handle("/login/bio?Hello%0Aworld", server.Alice)
	assert.Equal(fmt.Sprintf("30 /login/outbox/%s\r\n", strings.TrimPrefix(server.Alice.ID, "https://")), summary)
...
func TestBio_MultiLineWithLink(t *testing.T) {
	...
	summary := server.Handle("/login/bio?Hi%21%0A%0AI%27m%20a%20friend%20of%20https%3a%2f%2flocalhost.localdomain%3a8443%2fuser%2fbob", server.Alice)
	assert.Equal(fmt.Sprintf("30 /login/outbox/%s\r\n", strings.TrimPrefix(server.Alice.ID, "https://")), summary)
