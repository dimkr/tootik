...
func TestRegister_ProfanityFilter(t *testing.T) {
	assert := assert.New(t)
	...
	_, err = tlsReader.Write([]byte("gemini://localhost.localdomain:8965/users/register?poop\r\n"))
	assert.NoError(err)
