...
func (l *Listener) handleOutbox(w http.ResponseWriter, r *http.Request) {
	...
	if err := l.DB.QueryRowContext(r.Context(), `select id from persons where actor->>'$.preferredUsername' = ? and ed25519privkey is not null`, username).Scan(&actorID); err != nil {
