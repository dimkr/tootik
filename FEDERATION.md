...
A portable actor is created by generating or supplying a pre-generated, base64url-encoded Ed25519 private key during registration. The key, like the user's `preferredUsername`, must be unique per tootik instance.
