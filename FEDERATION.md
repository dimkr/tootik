...
* It occasionally (see `RFC9421Threshold` and `Ed25519Threshold`) signs outgoing `POST` requests with RFC9421 or Ed25519, to prevent deadlock if another server is waiting instead of advertising or demonstrating support
